...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    max_dice = 0
    for i in range(1,11):
        averged_dice = make_averaged(roll_dice,total_samples)(i, dice)
        if max_count < averged_dice:
            max_count = averged_dice
            max_dice = i
    return max_dice
    # END PROBLEM 9
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    if threshold <= tail_points(opponent_score):
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def final_strategy(score, opponent_score):
    ...
    if one or two away from a perfect square, roll 10 dices
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score == 99: 
        return 0
    elif next_perfect_square(score) - score <= 2: # if current score is 1 or 2 away from a perfect square, then roll 10 dices
        return 10
    elif square_strategy(score, opponent_score, 9, 6) == 0 or tail_strategy(score, opponent_score, 9, 6) == 0: # the max value of the expectation func is 9
        return 0
    else:
        return 6  
    # END PROBLEM 12
